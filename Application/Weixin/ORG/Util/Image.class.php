...
class Image {
     ...
     * @return void
     */
    static public function water($source, $water, $savename=null, $alpha=80,$weizhi) {
        //检查文件是否存在
        ...
        if($weizhi=="juzhong"){
            $posY = ($sInfo["height"] - $sInfo["height"]/2) - $wInfo["height"]/2;
            $posX = ($sInfo["width"] - $sInfo["width"]/2) - $wInfo["width"]/2;
        }
